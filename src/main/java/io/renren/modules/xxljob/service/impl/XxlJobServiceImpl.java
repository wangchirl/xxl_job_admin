package io.renren.modules.xxljob.service.impl;

import io.renren.modules.xxljob.core.cron.CronExpression;
import io.renren.modules.xxljob.core.model.XxlJobGroup;
import io.renren.modules.xxljob.core.model.XxlJobInfo;
import io.renren.modules.xxljob.core.model.XxlJobLogReport;
...
import io.renren.modules.xxljob.dao.*;
...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    @Override
    public PageQueryBaseVO<XxlJobInfo> pageList(int start, int length, int jobGroup, int triggerStatus, String jobDesc, String executorHandler, String author) {
        ...
        // package result
        PageQueryBaseVO<XxlJobInfo> vo = new PageQueryBaseVO<>();
    ...
    @Override
    public DashboardInitVO dashboardInfo() {
        ...
        DashboardInitVO vo = new DashboardInitVO();
        vo.setJobInfoCount(jobInfoCount)
                .setJobLogCount(jobLogCount)
                .setJobLogSuccessCount(jobLogSuccessCount)
    ...
    public ReturnT<ChartInfoVO> chartInfo(Date startDate, Date endDate) {
        ...
        vo.setTriggerDayList(triggerDayList)
